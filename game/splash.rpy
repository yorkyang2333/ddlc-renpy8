...
label readonly:
    ...
    "For macOS Users, Gatekeeper's App Translocation prevents the game from working properly."
    "Please move the DDLC application to your /Applications folder and try again."
    "Alternatively, you can clear the quarantine attribute by typing 'xattr -cr /path/to/DDLC.app' in Terminal."
    $ renpy.quit()
    return
